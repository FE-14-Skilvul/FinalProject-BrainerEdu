                    ...
                    <div className="container-fluid">
                        <div className="row align-items-center">
                            <div className="col-xl-2 col-lg-2 col-5">
                                <div className="logo">
                                    <Link to={'/'}>
                                        <img src="/assets/img/logo/logobrainerr.png" alt="" width={157} height={45} />
                                    </Link>

                                </div> </div> <div className="col-xl-7 col-lg-8 d-none d-lg-block">
                                        ...
                                        <div className="collapse navbar-collapse"
                                            ...
                                            <ul className="navbar-nav">
                                                ...
                                                <li className="nav-item">
                                                    ...
                                                    <Link to={'/about'}
                                                        className="nav-link">
                                                        Tentang </Link> </li> <li className="nav-item">
