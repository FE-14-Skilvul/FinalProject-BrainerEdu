...
const Register = () => {
    ...
    const saveAccount = async (e) => {
        ...
        try {
            ...
            const response = axios.post(VITE_BASE_URL + '/register', {
                            ...
                            <div className="col-lg-6 col-md-8 grid-item cat2 cat3">
                                <div className="z-gallery z-gallery-two mb-30" style={{ padding: '3rem' }}>
                                    <div className="contact-form-wrapper text-center mb-30">
                                        ...
                                        <form onSubmit={saveAccount} className="row gx-3 comments-form contact-form">
                                            <Input type="text" ref={namaRef} placeholder="Nama Lengkap" />
                                            <Input type="text" ref={usernameRef} placeholder="Username" />
                                            <Input type="text" ref={emailRef} placeholder="Email" />
                                            <Input type="password" ref={passwordRef} placeholder="Password" />
                                            <Input type="password" ref={repasswordRef} placeholder="Ulangi Password" />
                                            <button className="theme_btn message_btn mt-20 w-100">Simpan</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
