const Footer = () => {
    return ( <
        ...
        className = "logo" >
        <
        img src = "/assets/img/logo/logobrainerr.png"
        alt = ""
        width = { 157 }
        height = { 45 }
        /> <
        ...
        <
        div className = "col-xl-3 col-lg-4 col-md-6  wow fadeInUp2 animated"
        dataWowDelay = ".1s" >
        <
        ...
        p >
        Brainer Education menjadi solusi yang efektif untuk meningkatkan pengetahuan dan keterampilan di bidang programming, akuntansi, dan bahasa. <
        /p> <
        h5 className = "mail-to mt-25" > braineredu @gmail.com < /h5> <
        ...
        /div> <
        /div> <
        div className = "col-xl-3 col-lg-6 col-md-6  wow fadeInUp2 animated"
        dataWowDelay = ".7s" >
        <
        div className = "footer__widget footer__widget__two mb-30" >
        <
        ...
        <
        p >
        Copyright @ 2023 < a href = "#" > BrainerEdu < /a>. All Rights Reserved <
        /p> <
        /div> <
        /div> <
        div className = "col-lg-6 col-md-12 mb-20" >
