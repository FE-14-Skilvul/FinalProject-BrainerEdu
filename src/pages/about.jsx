              ...
              <div className="col-lg-5">
                <div className="about-wrapper">
                  <div className="section-title section-title-4 mb-60">
                    ...
                    <h2 className="mb-20">
                      Experience the thrill of mastering new skills and
                      transform your education into an exhilarating adventure!
                    </h2>{' '}
                    <p className="mb-20">
              ...
              <div className="row">
                ...
                <div className="col-xl-6 col-lg-6 col-md-6">
                  <div className="what-box text-center mb-3">
                    ...
                    <Link to={'/contact'} className="theme_btn border_btn">
                      Hubungi Kami{' '}
                    </Link>{' '}
                  </div>{' '}
                </div>{' '}
