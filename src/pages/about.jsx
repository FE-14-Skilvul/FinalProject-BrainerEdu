...
const About = () => {
    return ( <
        ...
        /div> <
        /div> <
        /section> { /*what-loking-for end*/ } { /* course-instructor start */ } <
        ...
        <
        img src = "assets/img/instructor/01.jpg"
        alt = "" / >
        <
        ...
        div className = "z-instructors__thumb mb-15" >
        <
        img src = "assets/img/instructor/02.jpg"
        alt = "" / >
        <
        div className = "social-media" >
        <
        ...
        div className = "z-instructors__thumb mb-15" >
        <
        img src = "assets/img/instructor/03.jpg"
        alt = "" / >
        <
        div className = "social-media" >
        <
        ...
        div className = "z-instructors__thumb mb-15" >
        <
        img src = "assets/img/instructor/04.jpg"
        alt = "" / >
        <
        div className = "social-media" >
        <
