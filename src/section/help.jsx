              ...
              <div className="col-xl-6 col-lg-6 col-md-6">
                <div className="what-box text-center mb-3">
                  ...
                  <p>
                    ...
                    kesulitan yang kamu hadapi, tim kami siap membantu.
                    Tingkatkan pemahamanmu, atasi tantangan, dan capai tujuanmu
                    dengan bantuan yang tepat. Jangan ragu untuk meminta
                    bantuan, kami di sini untuk membantu anda.{' '}
                  </p>{' '}
